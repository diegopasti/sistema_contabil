...
class Plano(models.Model):
    ...
    cadastrado_por   = models.ForeignKey(entidade, related_name="plano_cadastrado_por", default=0)
    data_cadastro    = models.DateTimeField(auto_now_add=True)
    ultima_alteracao = models.DateTimeField(null=True, auto_now=True)
    alterado_por     = models.ForeignKey(entidade, related_name="plano_alterado_por", default=0)
    ativo            = models.BooleanField(default=True)
